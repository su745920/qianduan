    ...
    <view class="options">
      <view class="item">
        <scroll-view :scroll-x="true" style="width: 100%;">
          ...
          <image src="/static/icon_arrow_up_16.png" style="width: 20px;height: 20px;z-index: 99999;" @click="closeTopKlineFn"></image>
	...
	onMessage() {
		...
		this.$store.state.webScoket?.onMessage(evt => {
			 ...
			 if(k.type === 'daymarket' && k.self === 1) {
				  this.$emit('getSocketData',k,true)
				 if (k.symbol?.toUpperCase() === coin) {
