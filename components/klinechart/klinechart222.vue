...
export default {
  ...
  methods:{
    subMarket() {
      let that = this;
      var socket = new SockJS('https://api.rhdghgt.buzz/market/market-ws');
    ...
    getHistoryDataV2(){
      ...
      let url="https://admin.coinbmex.com/api/currency/new_timeshar_v5?period="+period+"&size=200&symbol="+symbol;
      let data=[];
