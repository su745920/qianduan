	...
	<view class="">
		<view class="u-navbar" :style="[navbarStyle]" :class="{ 'u-navbar-fixed': isFixed, 'u-border-bottom': borderBottom }">
			...
			<view class="u-navbar-inner" :style="[navbarInnerStyle]">
				<view class="u-back-wrap" v-if="isBack&&showback" @tap="goBack">
					<view class="u-icon-wrap">

            <img src="@/static/toobit/icon_back.png" style="width: 10px;height: 21px;margin-top:2px;margin-left:10px;">
					</view>
