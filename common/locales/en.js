export default {
	...
	exchange_now:"Convert",
	bb_min_tx:'The minimum transaction amount is 5 USDT',
	confirm_place_order:'Are you sure you want to place the order?',
	trading_cryptod:'Transaction node',
	...
	exchange_tip:'No slippage丨One-click transactions',
	flash_to:'To',
	flash_from:'From',
	market_order:'Market Order',
	limit_order:'Limit Order',

	flash_exchange:"Convert",
	home_mail:'Messages',
	trading_crypto:'Trading crypto',
	current_price:'Price',
	market_fee:'Market fee/Countdown',
	fenshi:'Time',
	asset_analysis:'Asset Analysis',
	today_pnl:'Today‘s PnL',
	my_account:'My Account',
	add_favorities:"Add to Favories",
	trading_Fee:"Trading Fee",


	amountTip: "Please enter the amount",
	more:"More",
	settingV2024:"Setting",
	leftmenu:{
		shortcuts:"Shortcuts",
		referral:"Referral",
		support:"Support",
		...
		rewards_perks:"Rewards and perks",
		affiliate:"Affiliate",
		school:"school",
	...
	earn:"Earn",
	earn1:"Grow your assets easily on Earn",
	earn2:"What is Simple Earn?",
	total_Investment:"Total Investment",
	yesterday_Earnings:"Yesterday's Earnings",
	total_Earnings:"Total Earnings",

	qiquan:'Options',
	home1:"Master the BBcoin Universe",
	home2:"Embark on a new trading journey.",
	home3:"Deposit",
	home4:"Spot",
	home_earn1:"Earn returns without fearing market volatility. ",
	home_earn2:" Settled daily, withdraw and deposit at will, safe and reliable.",
	home_earn3:"Get Started",
	home_announcement:"Announcement",

	convert_hint:'Please enter the transfer quantity',
	rebate_rules:"Rebate rules",
	inviteFriends:{
		titleA:"Explanation of Binancb invitation commission rebate rules",
		titleA_1:"1. Invite new users to register for Binancb, share commission rewards, and there is no limit to the number of invited friends per account;",
		titleA_2:"2.After a friend accepts the invitation and conducts a transaction, a corresponding percentage (up to 20%) of commission rebate rewards will be generated",
		titleA_3:"3.The inviter can choose a lower level commission rebate ratio (5%, 10%, 15%) to enjoy transaction commission rebates together with the invitee",
		titleA_4:"4.Spot commission rebate and contract commission rebate are in parallel, with commission settled daily and returned to the Binancb account after settlement。",

		titleB:"Supplementary explanation:",
		titleB_1:"1.Transaction commission rebate base=transaction amount * corresponding currency rate - additional handling fee discount;",
		titleB_2:"2.Binancb prohibits multiple accounts from self inviting. Once verified, all associated account rewards will be cancelled;",
		titleB_3:"3.Binancb will adjust the commission rebate rules according to the actual situation and enjoy the final interpretation right for this activity。",


	},
	bind: {
		copyokin: 'Replicating Success',
	},
	input_cz_amount:'Please enter the recharge amount',
	b_yhmc:"Bank Name",
	b_zhhm:"Account No",
	b_skzhmc:"Receiving account name",
	b_yhdz:"Bank address",
	b_gsdz:"Company address",
	b_fz:"copy",
	payer:'payer',
	recharge_amount:'Amount',
	input_fukuanren:'Please enter the payer',
	please_input_amount:'Please enter the quantity',
	please_input_1_9999999:'按其他币种的请输入数量',


	please_consult_customer_service:'Please select the recharge amount',
	tjcg:'submitted successfully',
	lever00:'lever',
	cz_tipA:"Hello respected user, if you need to purchase cryptocurrency with a bank card, please contact online customer service",
	...
	input_target_profit_price:'please input',
	tp_price:'TP Price',
	sl_price:'SL Price',
	spont_assets:'Assets',
	invite:{
		commission:'commission',
		a:'Invite friends to earn together',
		b:'Up to',
		c:'rebate',
		d:'View Referral Rules',
		e:'Invite Friends',
		f:'Invite Code',
		g:'Invitation Link',
		...
		subordinate_account:'Subordinate account',
		share_posters:'Share posters',
	},
	market:{
		favorites:'Favorites',
		tabA1:'Quotes',
	...
	assets:{
		...
		spotAccount:'Exchange',
		futuresAccount:'Contracts',
		optionsAccount:'Option',
		earnAccount:'Minging',
	...
	//invite_fanyong:'邀请返佣',
	trade_yinlil:'profit rate',

	tabA0:'Cryptocurrency',
	tabA1:'US shares',
	tabA2:'Foreign exchange',
	tabA3:'Precious metal',
	tabA4:'New',
	tabA5:'Turnover',

	nav: ['Home', 'Markets', 'Trade', 'Contracts', 'Grow','Assets'],
	common: {
		search: 'Search',
		confirm: "OK",
		cancel: "Cancel",
	...
	setting: {
		...
		authentication_text_9: 'Reminder: In order to protect the security of user funds, please complete the binding of email first, otherwise your authentication will fail. ',
		...
		uploadIdcardFront: 'Upload ID card',
	...
	transaction: {
		...
		lots: "hand",
		setProfitLoss: "TP/SL",
		setProfitLossV2:"Take profit and stop loss",
		...
		completeOrder:'Trade',
		entrustIn:"entrust in",
		cancelEntrust: 'Cancel entrust'
	},
	fund: {

		legalTransfer:"Legal Transfer",
		money:"Legal Transfer",
		recharge_log:'Deposit Records',
		overview: 'Overview',
		balance: 'balance',
		futures: 'contract',
		deposit: 'Deposit',
		...
		payPassword:"Withdrawal password",
		plsPayPassword: "Please enter withdrawal password",
		reason: "Reason"
	},
	ieo: {
		subscribe: "Subscribe",
	...
	lockming: {
		...
		expiredDistribution:"Expired distribution",
		get: "get",
	...
	follow: {
		follow_tip:'Follow the Pro,Profit like a Pro',
		follow: 'Copy',
		traderList: 'Trader Rank',
	...
	bound: 'Already bound',
	recharge_loading:"Recharge in progress",
	recharge_success:"Recharge successful",
	recharge_fail:"Recharge failed",
	withdraw_loading:"Withdrawing in progress",
	withdraw_success:"Withdrawal successful",
	withdraw_fail:"Withdrawal failed",
	cancelSuccess: 'Cancel successfully',
	member_level: 'Member level',
	recharge_amount: 'Recharge amount',
	sdscrz: 'Set up dual authentication',
	smewm: 'Please use Google Authenticator to scan the QR code, or copy the code to manually add it',
	qwyz: 'Go to verify',
	srqrm: 'Enter confirmation code',
	srqrm1: 'Enter a 6-digit confirmation code',
	google_code: 'Google verification code',
	google_code_placeholder: 'Please enter the Google verification code',
	loan: {
		a1: "After platform review, you can apply for a loan from the platform",
		a2: "Expected loan amount",
		a3: "Enter",
		a4: "Repayment cycle",
		a5: "day",
		a6: "Please select",
		a7: "Daily interest rate",
		a8: "Repayment method",
		a9: "Repayment at maturity",
		a10: "interest",
		b1: "Handling fee rate",
		b2: "commission",
		b3: "Lending institutions",
		b4: "Credit loan (image upload)",
		b5: "Housing information",
		b6: "Proof of Income (Employment Relationship)",
		b7: "Bank Details",
		b8: "Photo",
		b9: "Read and agree",
		b10: "loan agreement",
		c1: "Please enter the loan amount",
		c2: "Please select the repayment period",
		c3: "Please upload the house information",
		c4: "Please upload proof of income",
		c5: "Please upload bank details",
		c6: "Please upload your ID photo",
		c7: "Please agree to the loan agreement first",
		c8: "Order No.",
		c9: "Loan application time",
		c10: "Loan review time",
		d1: "Audit",
		d2: "Loan amount",
		d3: "Loan cycle",
		d4: "interest",
		...
		d6: "Remaining amount",
		d7: "state",
		d8: "Go ahead and repay",
		d9: "Loan successful",
		d10: "Loan refusal",
		e1: "Pending repayment",
		e2: "Repayment in progress",
		e3: "Refusal of repayment",
		e4: "Repaired",
		e5: "Repayment amount",
		e6: "Please enter the repayment amount",
		e7: "repayment method",
		e8: "Quantity to be returned",
		e9: "Repayment voucher",
		e10: "Confirm repayment",
		money: "Amount",
		f1: "Please upload the repayment voucher"
