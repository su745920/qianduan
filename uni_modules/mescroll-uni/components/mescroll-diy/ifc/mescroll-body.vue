		...
		<view class="mescroll-body-content mescroll-wxs-content" :style="{ transform: translateY, transition: transition }" :change:prop="wxsBiz.callObserver" :prop="callProp">
			...
			<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="{'background':mescroll.optDown.bgColor,'color':mescroll.optDown.textColor}">
				<view class="downwarp-content">
					...
					<view  v-if="isDownLoading" style="">
						<image src="../../../../../static/BrowserPreview_tmp.gif" style="height: 40rpx; width:40rpx"></image>
					</view>
					<view v-else class="color: #ffffff; font-size:25px;">IFC...</view>
					<!-- <view class="downwarp-mascot"></view> -->
					<!-- <view v-if="isDownLoading" class="downwarp-loading mescroll-rotate">11111</view>
					<view v-else class="downwarp-progress" :style="{'transform':downRotate}">22222</view>
					<view class="downwarp-mascot"></view> -->
				</view>
			</view>
