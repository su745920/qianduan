		...
		<view class="page">
			...
			<view class="xiyi">
				<label @click="isChecked = !isChecked" class="d-flex align-items-center">
					<checkbox :checked="isChecked" style="transform: scale(.7);" /><view >{{$t('loan.b9')}} <text class="xiyi_desc" @click.stop="$utils.jump('/pages/common/article?id=' + xyId)">《{{$t('loan.b10')}}》</text> </view>
				</label>
			</view>
