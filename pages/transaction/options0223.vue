  ...
  <view style="background: #000000;padding-bottom: 200px;">
    ...
    <view class="p-30">
      <view style="display: flex;">
        <view style="flex: 1;color: #f5f5f5;font-size:16px;justify-content: flex-start">
          现价
        </view>
      ...
      <view class="d-flex-between-center py-40">
        <text style="font-weight: 700;">交易币种</text>
      ...
      <view class="d-flex-between-center py-0" style="display: flex;margin-top: -20px;">
        ...
        <view :class="currentPayCoin==1 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;"  @click="currentPayCoin=1">
          <view
              style="font-weight: 700;font-size: 18px;margin-top: 6px;margin-bottom: 6px;margin-left: 12px;margin-right: 12px;">
            BTC
          </view>
        </view>
        <view :class="currentPayCoin==2 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;"  @click="currentPayCoin=2">
          <view
              style="font-weight: 700;font-size: 18px;margin-top: 6px;margin-bottom: 6px;margin-left: 12px;margin-right: 12px;">
            ETH
          </view>
        </view>
        <view :class="currentPayCoin==3 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;"  @click="currentPayCoin=3">
          <view
              style="font-weight: 700;font-size: 18px;margin-top: 6px;margin-bottom: 6px;margin-left: 12px;margin-right: 12px;">
            TRX
          </view>
      ...
      <view class="d-flex-between-center py-10" style="display: flex;">
        <view :class="currentTime==0 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;display: flex;flex-direction: column;"  @click="currentTime=0">
        ...
        <view :class="currentTime==1 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;display: flex;flex-direction: column;"  @click="currentTime=1">
        ...
        <view :class="currentTime==2 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;display: flex;flex-direction: column;"  @click="currentTime=2">
        ...
        <view :class="currentTime==3 ?'tran_btn':'tran_btn_normal' " style="flex: 1;margin: 7px;display: flex;flex-direction: column;"  @click="currentTime=3">
      ...
      <view class="py-10" style="border:1px solid #333;margin-top: 8px;display: flex;border-radius: 8px;">
        <input type="number" v-model="number" class="trade-input mt-10 " :placeholder="amountTip" placeholder-style="color:#939393;"
    ...
    <block v-if="currentNav == 1">
      ...
      <view class="footer font-size-22" v-if="symbolQuotation1.close">
        ...
        <view class="btn btn1" @click="funA" style="background: #01c698;margin: 20px;height: 40px;border-radius: 26px;">
        ...
        <view class="btn btn2" @click="funB" style="background: #DE4a56;margin: 20px;height: 40px;border-radius: 26px;">
          <!--          <text class="">{{ Number(symbolQuotation1.close).toFixed(4) }}</text>-->
  ...
  computed: {
    ...
    expectedPL() {
      ...
      if (this.oldPrice>0) {
        ...
        console.log("预测结果==> profit_ratio=>"+profit_ratio+"  number==>"+number+" newprice="+newprice+" oldPrice="+this.oldPrice);
