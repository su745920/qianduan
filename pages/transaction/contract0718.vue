  ...
  <view style="background: #000000">
    ...
    <view style="background: #000000;margin-left: 10px;margin-right: 8px;">
      <u-navbar style="background: #FFFFFF">
        ...
        <image src="/static/icon_trade_more.png" slot="right" size="42" @click="showMoreBottomMenu=true"
        ...
        <view class="d-flex-between-center" style="background: #000000;display: flex;flex-direction: row;"
          ...
          <view style="width:240px;">
            <timeKline :currency_name="currency_name" legal_name="USDT"
                       @getSocketData="getSocketData" @buyListFn="buyListFn" @sellListFn="sellListFn"
                       @buyListCountFn="buyListCountFn" @sellListCountFn="sellListCountFn"
                       ref="child" style="margin-top: -44px;width: 240px;">
            </timeKline>
          </view>
        ...
        <view class="d-grid mt-0 align-items-center" style="grid-template-columns:2fr 1.2fr;background: #000000;">
          ...
          <view class="pr-20 position-relative opacity-90" style="height: 820rpx;margin-top: -40px;">
            ...
            <view style="display: flex;width: 160px;display: flex"  v-if="lang === 'th' ">
              <view style="background:transparent;flex: 2;display: flex;border-radius: 4px;border: 1px solid #242424;"
            ...
            <view style="display: flex;width: 170px;display: flex"  v-else-if="lang === 'vi' ">
              <view style="background: #f1f1f1;flex: 2;display: flex;border-radius: 4px;" @click="showWarehousePopFn">
                <view style="color: #ffffff;margin: 5px;font-weight: 500;margin-left: 8px;">{{warehouseText}}</view>
                <view><image src="/static/icon_triangle_down_white_16.png"  style="width: 20px;height:20px;margin: 5px;margin-top:5px;"></image></view>
              </view>
              <view style="background: #f1f1f1;flex: 1;display: flex;border-radius: 4px;margin-left: 10px;" @click="showLeverPopFn">
            ...
            <view style="display: flex;width: 180px;display: flex"  v-else>
              <view style="background:transparent;flex: 1;display: flex;border-radius: 4px;border: 1px solid #242424;" @click="showWarehousePopFn">
                <view style="color: #ffffff;margin: 5px;font-weight: 500;margin-left: 8px;">{{warehouseText}}</view>
                <view><image src="/static/icon_triangle_down_white_16.png"  style="width: 20px;height:20px;margin: 5px;margin-top:5px;"></image></view>
              </view>
              <view style="background:transparent;flex: 1;display: flex;border-radius: 4px;margin-left: 10px;border: 1px solid #242424;" @click="showLeverPopFn">
                <view style="color: #ffffff;margin: 5px;font-weight: 500;margin-left: 8px;">{{leverNumber}}X</view>
                <view><image src="/static/icon_triangle_down_white_16.png"  style="width: 20px;height:20px;margin: 5px;margin-top:5px;"></image></view>
              </view>
            </view>
            ...
            <view class="d-flex mt-20 buy-type font-size-30 d-flex-between-center" @click="showLimitMarketPopUp=true;"
                  style="border: 1px solid #232323;height: 35px;line-height: 35px;border-radius: 4px;">
            ...
            <view class="mt-20 " v-if="buyType==1"
                  style="border: 1px solid #333;height: 35px;border-radius: 4px;display: flex;line-height: 35px;">
              ...
              <input type="number" v-model="price" class="" :placeholder="i18n.price"
            ...
            <view class="mt-20 " style="border: 1px solid #333;height: 35px;line-height: 35px;
            ...
            <view class="mt-20">
              <view class="d-flex-between-center">
                ...
                <input type="number" v-model="number"
                       ...
                       style="color: #ffffff;width: 90px;background:transparent;border: 1px solid #242424;">

                <text class="d-block" style="color: #939393;">USDT</text>
              </view>

              <uv-slider v-model="number" :min="0" :max="user_lever" block-size="12"
            ...
            <view class="mt-46">
              ...
              <div class="mt10 input-item clear priceID" v-if="zyzs == true"
                ...
                <input
                    ...
                    border-bottom: none;flex: 1;line-height: 35px;margin: 5px;border: 1px solid #242424;height: 35px;padding-left: 10px;border-radius: 4px;"
                >
                ...
                <input
                    ...
                    placeholder-style="color:#939393;font-size:14px;"
                    style="font-size:14px;flex: 1;color: #ffffff;border-bottom: none;line-height: 35px;margin: 5px;border: 1px solid #242424;margin-left: 10px;height: 35px;padding-left: 10px;border-radius: 4px;"
                >
        ...
        <u-popup v-model="showConfirmPop"   border-radius="10" length="96%" contentBackgroundColor="#000000"
          ...
          <view class="p-30">
            ...
            <view class="d-flex-between-center border-bottom-white py-16">
              ...
              <text class="font-weight-bold" style="color: #ffffff;">{{margin}}</text>
            </view>
      ...
      <view style="margin-top: -40px;">
        <view style="left: 20rpx;right: 20rpx;display: flex;">
          <button class="success-button mt-60 py-0 font-size-28"
                  @click="openLong"
                  style="height: 70rpx;line-height: 70rpx;flex: 1;margin: 10px;">
            {{$t("kaiduo")}}
          </button>
          ...
          <view v-if="positionList.length" class="p-30 border-bottom text-black" v-for="item in positionList">
            ...
            <view class="d-grid-columns-3" style="justify-content: space-between;display: flex;">
              ...
              <view class="my-8">
                ...
                <text class="d-block font-size-30 font-weight-bold mt-8" style="color: #ffffff;">{{Number(symbolQuotation.now_price).toFixed(4)}}</text>
              </view>
            ...
            <view class="d-flex align-items-center mt-20" style="flex-direction: row-reverse;" v-if="item.status == 1">
              <button class="error-button font-size-22 py-0 px-70 mx-0" v-if="item.order_type == 1" @click="cover(item.id)"
                      style="color: #000000;background: #f7f7f7;border-radius: 20px;opacity: 1;font-size: 16px;font-weight: 700;">{{i18n.cover}}</button>
              <button class="warning-button font-size-22 py-0 px-70 mx-0" v-else-if="item.order_type == 2" @click="selfHold(item.id)"
                      style="color: #000000;background: #f7f7f7;border-radius: 20px;opacity: 1;font-size: 16px;font-weight: 700;">{{i18n.transSelfHold}}</button>
              <button class="primary-button font-size-22 py-0 px-70 mr-0 mr-20" @click="editFunc(item)"
                      style="color: #000000;background: #f7f7f7;border-radius: 20px;opacity: 1;font-size: 16px;font-weight: 700;">{{i18n.setProfitLossV2}}</button>
            </view>
          </view>
...
export default {
  ...
  data() {
    return {
      ...
      warehouseText: this.$t('isolated'),
      warehouse: 0,// 0:逐仓 1：全仓
      value1: 1,
      leverNumber: 100,
      ...
      lang: 'en',
      zyzs: false,
      zyzsIv: "/static/uzx/icon_coin_select_no.png",
      expectedProfit: "",
      expectedLoss: "",
    ...
    if (token==null||token.length<10){
      ...
      uni.request({
        ...
        success: function (response) {
          ...
          that.symbolQuotation.change = (close - open) / open;

          if (that.price == null || that.price == 0) {
            that.price = Number(close);
          }
  ...
  methods: {
    ...
    getDepthFn(){
      let that=this;
      let currencyNameStr = that.currency_name;
      currencyNameStr = currencyNameStr.toUpperCase();
      let url = "https://api.coinonebtc.xyz/market/binance/spot/depth2?symbol="+currencyNameStr+"USDT";
      let data = [];
      uni.request({
        url: url,
        method: "GET",
    ...
    subMarketDepth() {
      let that = this;
      let currency_nameStr=that.currency_name;
      currency_nameStr=currency_nameStr.toLowerCase();
      let pushUUID = uni.getStorageSync("pushUUID");
      if (pushUUID == null || pushUUID.length < 10) {
        pushUUID = this.uuid();
      ...
      uni.onSocketMessage(function (res) {
        try {
          ...
          if (cmd === "depth"&&currency_nameStr===coin) {
            ...
            if (outList && outList.length > 0) {
              ...
              that.sellMaxValue = max1;
              that.sellList = outList.slice(0, 8);
            }
    ...
    getMySwapAssetsFn(){
      ...
      this.$https.initDataToken({
        ...
        that.user_lever=Number(that.user_lever).toFixed(2);
      });
    },
    ...
    // 获取所有行情
    getQuotation() {
      let url = "https://api.coinonebtc.xyz/market/binance/redis/getLatestQuotations";
      let data = [];
      let that=this;
      uni.request({
        url: url,
        ...
        success: function (response) {
          data = response.data;
          that.quotation = data.data;

          that.originalQuotation = data.data;
    ...
    setStopFn(){
      ...
      this.$https.initDataToken({
        ...
        that.getLeverDeal(this.symbolQuotation.currency_id,this.symbolQuotation.legal_id);
    ...
    cover(id){
      ...
      that.$u.throttle(async ()=>{
        ...
        this.$https.initDataToken({
          ...
          that.$utils.showToast(res)
          that.getLeverDeal(that.symbolQuotation.currency_id,that.symbolQuotation.legal_id);
